...
{	
    ...
    /// </summary>
    public class TcpListener : IConfigurableListener
    {
        ...
        public TcpListener(string endpoint, int port, string messagePrefix)
        {
            _log = Logger.GetLogger(MethodBase.GetCurrentMethod().DeclaringType);
        ...
        protected void Listen()
        {
            ...
            try
            {
                ...
                _tcpListener.Start();
                _log.Info(GetHashCode(), "Started listening for TCP on port " + _port.ToString() + " using prefix: " + _messagePrefix);
        ...
        public Session Session
        {
            set
            {
                if (_log.Enabled) _log.Debug(GetHashCode(), "Session get");
                _session = value as Session; 
            }
        }
        /// <summary>
