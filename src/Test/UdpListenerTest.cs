...
namespace logview4net.test
{
	...
	public class UdpListenerTest
	{
		...
		public void ListenTest()
		{
			...
			string[] messages = new string[] {"johan", "testar"};
			UdpSender us = new UdpSender(_testEndpoint, _testPort,  messages, 200);
			us.Start();
			
			//Thread.Sleep(1000); //To let the message go through the network stack
