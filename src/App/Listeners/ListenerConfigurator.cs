...
namespace logview4net.Listeners
{
    ...
    {
        private IConfigurableListener _listener;
        ...
        public ListenerConfigurator(IConfigurableListener listener, Session session)
        {
            _session = session;
            InitializeComponent();
            _listener = listener;
        ...
        public string Configuration
        {
            ...
            set
            {
                ...
                _listener = (IConfigurableListener)xs.Deserialize(sr);
        ...
        public IListener Listener
        {
            get
            {
                return (IListener)_listener;
            }
            set
            {
                _listener = (IConfigurableListener)value;
            }
        }
